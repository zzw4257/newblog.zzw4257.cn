---
title: CSRF 与 XSS：跨站请求伪造与跨站脚本攻击
description: 本文系统介绍 CSRF（跨站请求伪造）和 XSS（跨站脚本攻击）的核心概念、攻击原理、针对 GET/POST 服务的攻击手法、防御措施（CSRF Token、SameSite Cookie、CSP）等，是 Web 安全课程的重要内容。
