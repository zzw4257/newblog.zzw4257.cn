---
title: AIGC 发展史：从 GANs 到扩散模型的视觉生成技术演进
description: 本文系统梳理了视觉AI生成技术的发展历程，从生成对抗网络（GANs）、变分自编码器（VAEs）到扩散模型（Diffusion Models），以及 LoRA、ControlNet 等现代AIGC工具箱的核心技术，是理解当前AIGC生态的重要参考。
pubDate: 2025-09-01T12:00:00.000Z
...
### 1.1 基础生成架构：三大支柱
> **注：** 原文档中的三大生成架构对比示意图（此处省略，详见课程材料）
...
> **注：** 原文档中的 GANs 架构示意图（此处省略，详见课程材料）
...
> **注：** 原文档中的 VAEs 架构示意图（此处省略，详见课程材料）
...
> **注：** 原文档中的 LoRA/DreamBooth 对比示意图（此处省略，详见课程材料）
...
![Qwen-Image 编辑界面](https://qianwen-res.oss-accelerate-overseas.aliyuncs.com/Qwen-Image/edit_homepage.jpg)
