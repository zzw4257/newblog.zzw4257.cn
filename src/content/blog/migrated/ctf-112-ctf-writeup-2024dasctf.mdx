---
title: 11.2 CTF省赛 Writeup
description: 'TODO: 补充摘要 —— 11.2 CTF省赛 Writeup'
...
tags:
  - 11.2 CTF省赛 Writeup
image: /images/uploads/ctf-112-ctf-writeup-2024dasctf-cover.jpg
---
...
![image-20241102123822030](/images/uploads/ctf-112-ctf-writeup-2024dasctf/image-20241102123822030.png)
...
![image-20241102131431471](/images/uploads/ctf-112-ctf-writeup-2024dasctf/image-20241102131431471.png)

看了下js啥也没有

仔细看一下弹窗，也没有什么直白信息

![image-20241102132726895](/images/uploads/ctf-112-ctf-writeup-2024dasctf/image-20241102132726895.png)

还有唬人的骗局

![image-20241102134155012](/images/uploads/ctf-112-ctf-writeup-2024dasctf/image-20241102134155012.png)

发现，题和答案比较直白

![image-20241102133726425](/images/uploads/ctf-112-ctf-writeup-2024dasctf/image-20241102133726425.png)

应该能从答案入手直接填空

通过抄答案获得flag

![image-20241102134000204](/images/uploads/ctf-112-ctf-writeup-2024dasctf/image-20241102134000204.png)
...
![image-20241102155920264](/images/uploads/ctf-112-ctf-writeup-2024dasctf/image-20241102155920264.png)
...
![out](/images/uploads/ctf-112-ctf-writeup-2024dasctf/out.png)

暂时没分析明白其要义

![image-20241102151002474](/images/uploads/ctf-112-ctf-writeup-2024dasctf/image-20241102151002474.png)

这里提示我们IEND后面有额外信息

但是啥也不是？

![image-20241102151020317](/images/uploads/ctf-112-ctf-writeup-2024dasctf/image-20241102151020317.png)

### T2 机密文档

> 给一个加密的zip，然后破解其密码

![image-20241102135703285](/images/uploads/ctf-112-ctf-writeup-2024dasctf/image-20241102135703285.png)
...
![image-20241102163334963](/images/uploads/ctf-112-ctf-writeup-2024dasctf/image-20241102163334963.png)
...
![image-20241102143534329](/images/uploads/ctf-112-ctf-writeup-2024dasctf/image-20241102143534329.png)

![image-20241102143707831](/images/uploads/ctf-112-ctf-writeup-2024dasctf/image-20241102143707831.png)
...
![image-20241102141235046](/images/uploads/ctf-112-ctf-writeup-2024dasctf/image-20241102141235046.png)
...
![image-20241102140838958](/images/uploads/ctf-112-ctf-writeup-2024dasctf/image-20241102140838958.png)
