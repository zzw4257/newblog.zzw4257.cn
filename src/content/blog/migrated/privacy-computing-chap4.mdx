...
description: 本章引入形式化的密码学安全模型——通用可组合性框架（UC framework），包括半诚实与恶意敌手模型、隐私性与恶意安全性的形式化定义、理想世界与现实世界的对比、UC框架的核心思想与组件等内容，是隐私计算课程的理论核心。
pubDate: 2025-10-18T12:00:00.000Z
image: /images/uploads/curricular-4-security-models-chap4-securitymodel-cover.jpg
badge: Course
draft: false
categories:
  - Privacy Computing
